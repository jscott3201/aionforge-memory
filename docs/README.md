...
- [Agent messages](messages.md) — durable addressed delivery between agents and teams:
  authenticated sender metadata, recipient-inbox namespaces, untrusted poll/wait rendering,
  bounded wakeups, guarded acknowledgement, and ack-aware retention outside recall and forgetting.
