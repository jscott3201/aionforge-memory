...
//! ([`fuse`], M1.T05), the mandatory query-class router ([`route`], M1.T06) that picks
//! the mode weights, and the [`HybridRetriever`] (M1.T07) that runs the whole path and
//! returns a deterministic [`RecallBundle`] (03). The graph, recency, and trust
//! signals land with their tasks.
