...
pub(crate) const TOOLS: &[ToolSurface] = &[
    ...
    ToolSurface {
        name: "memory_census",
        class: ToolClass::ReadLike,
        default_output: "[memory_census] namespace counts or paginated visible memories",
        verbose: true,
        read_only_hint: true,
        destructive_hint: false,
        idempotent_hint: true,
        open_world_hint: false,
        errors: &[
            "ERR_INVALID_CENSUS_MODE",
            "ERR_INVALID_NAMESPACE",
            "ERR_INVALID_MEMORY_KIND",
            "ERR_INVALID_CENSUS_CURSOR",
            "ERR_INVALID_CENSUS_CURSOR_ID",
