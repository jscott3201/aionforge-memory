...
pub(crate) const TOOLS: &[ToolSurface] = &[
    ...
    ToolSurface {
        name: "message_poll",
        class: ToolClass::ReadLike,
        default_output: "[message_poll] page plus wrapped visible messages",
        verbose: false,
        read_only_hint: true,
        destructive_hint: false,
        idempotent_hint: true,
        ...
        errors: &[
            "ERR_INVALID_ROOM_ID",
            "ERR_INVALID_MESSAGE_CURSOR",
            "ERR_INVALID_MESSAGE_CURSOR_ID",
    ...
    ToolSurface {
        name: "message_wait",
        class: ToolClass::ReadLike,
        default_output: "[message_wait] page and timed_out; over-recipient-cap polls once, returns pending mail, and never parks or errors",
        verbose: false,
        read_only_hint: true,
        destructive_hint: false,
    ...
    ToolSurface {
        name: "message_send",
        class: ToolClass::Mutating,
        default_output: "[message_send] receipt line",
        verbose: false,
        read_only_hint: false,
        destructive_hint: false,
        idempotent_hint: false,
        ...
        errors: &[
            ...
            "ERR_INVALID_REPLY_TO_ID",
            "ERR_INVALID_MESSAGE_KIND",
            "ERR_MESSAGE_SEND",
        ],
    },
    ToolSurface {
        name: "message_ack",
        class: ToolClass::Mutating,
        default_output: "[message_ack] batch tally plus per-id outcomes",
        verbose: false,
        read_only_hint: false,
        destructive_hint: false,
        idempotent_hint: true,
        ...
        errors: &[
            "ERR_NO_MESSAGE_IDS",
            "ERR_TOO_MANY_MESSAGE_IDS",
            "ERR_INVALID_MESSAGE_ID",
            "ERR_INVALID_MESSAGE_READ_STATE",
            "ERR_READ_ONLY_PRINCIPAL",
            "ERR_PRINCIPAL_REQUIRED",
            "ERR_MISSING_PRINCIPAL",
            "ERR_INVALID_VIEWER",
