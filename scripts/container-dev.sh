...
IMAGE="${AIONFORGE_CONTAINER_IMAGE:-ghcr.io/jscott3201/aionforge-memory:0.2.0}"
...
Environment:
  AIONFORGE_CONTAINER_IMAGE   Image to run (default: ghcr.io/jscott3201/aionforge-memory:0.2.0)
