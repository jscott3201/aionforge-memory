...
ARG AIONFORGE_BUILD_SHA
ARG AIONFORGE_BUILD_STATUS
ARG AIONFORGE_BUILD_TIMESTAMP

ENV CARGO_NET_GIT_FETCH_WITH_CLI=true
ENV AIONFORGE_BUILD_SHA=${AIONFORGE_BUILD_SHA}
ENV AIONFORGE_BUILD_STATUS=${AIONFORGE_BUILD_STATUS}
ENV AIONFORGE_BUILD_TIMESTAMP=${AIONFORGE_BUILD_TIMESTAMP}
